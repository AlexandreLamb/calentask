...
class Finder:
    ...
    def run(self):
        command = """sudo iwlist wlp0s20f3 scan | grep -ioE 'ssid:"(.*{}.*)'"""
    ...
    def connection(self):
        try:            
            os.system("nmcli d wifi connect {} password {}".format(self.server_name,self.password))
        except:
            raise
        else:
            return True
...
if __name__ == "__main__":
    ...
    server_name = "LAWIFIDESCHERCHEURS"
