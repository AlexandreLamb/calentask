...
class VideoForm extends React.Component {
  ...
  handleSubmit = (rateValue) => {
    ...
    this.setState({
      ...
      displayVideoRate: false,
      isStopWatchingVideo:
        this.state.rateValueChecked.length === 3 ? true : false,
    });
  ...
  manageButton = (videoLetter) => {
    let isSequenceIsViewedOneTime =
      this.props.sequence[videoLetter].numberOfViews == 1 ? true : false;
    let totalViews = 0;
    ...
    // Ordre des buttons
    if (
      this.props.sequence["A"].numberOfViews == 0 &&
      (videoLetter == "B" || videoLetter == "C" || videoLetter == "D")
    )
      isSequenceIsViewedOneTime = true;

    if (
      this.props.sequence["A"].numberOfViews == 1 &&
      this.props.sequence["B"].numberOfViews == 0 &&
      (videoLetter == "C" || videoLetter == "D")
    )
      isSequenceIsViewedOneTime = true;

    if (
      this.props.sequence["A"].numberOfViews == 1 &&
      this.props.sequence["B"].numberOfViews == 1 &&
      this.props.sequence["C"].numberOfViews == 0 &&
      videoLetter == "D"
    )
      isSequenceIsViewedOneTime = true;
        ...
        >
          ...
          {this.props.playing === false /* && 
            ...
            <div>
              ...
              >
                <Card.Body>
                  <div
                    className="rounded SequenceTime"
                    style={{
                      fontWeight: "bold",
                      textAlign: "left",
                      fontSize: "1.2rem",
                  ...
                  >
                    L’objectif de cette étude est de vous demander de classer
                    dans l'ordre chronologique 4 séquences vidéos de 10 secondes
                    (A, B, C, D), qui correspondent à 4 moments dans une tâche
                    fatigante :<br></br> <br></br>
                  </div>
                  ...
                  <div>
                    ...
                    1. Visionner une fois les 4 séquences vidéo dans l'ordre
                    suivant : A,B,C puis D.
                    </div>
                    <br></br>
                    <div style={{paddingLeft:"10%"}}>
                    ...
                    <br></br>
                    <div style={{paddingLeft:"10%"}}>
                    3. Classer le moment (0 min, 15 min, 30 min ou 45 min) de la
                    séquence vidéo selectionnée ou bien décider de la
                    revisionner.
                    </div>
                    <br></br>
                    <div style={{paddingLeft:"10%"}}>
              ...
              <Form.Group>
                ...
                >
                  Attention : une fois que vous avez classé une vidéo, il ne
                  vous sera pas possible de revenir en arrière !
                </Form>
              </Form.Group>
              <Container
                className="rounded shadow"
              ...
              >
                <Row style={{ paddingTop: "15px", textAlign: "center" }}>
                  ...
                  <Form className="col-1" style={{ paddingTop: "0px" }}>
                    <Image
                      style={{
                        display: this.manageButton("A") ? "none" : "block",
                      }}
                      fluid={true}
                      src="Picture3.png"
                      height="100%"
                  ...
                  <Form className="col-4" style={{ alignItems: "center" }}>
                    <Button
                      disabled={this.manageButton("A")}
                      variant="secondary"
                      style={{
                        width: "80%",
                        marginBottom: "1%",
                        backgroundColor: this.manageButton("A")
                          ? "rgba(49,70,107,0.5)"
                          : "rgba(49,70,107,1)",
                      }}
                ...
                <Row style={{ paddingTop: "5px", textAlign: "center" }}>
                  ...
                  <Form className="col-1" style={{ paddingTop: "0px" }}>
                    <Image
                      style={{
                        display: this.manageButton("B") ? "none" : "block",
                      }}
                      fluid={true}
                      src="Picture3.png"
                      height="100%"
                  ...
                  <Form className="col-4" style={{ alignItems: "center" }}>
                    <div id="sequenceButtonB">
                      <Button
                        disabled={this.manageButton("B")}
                        variant="secondary"
                        style={{
                          width: "80%",
                          marginBottom: "1%",
                          backgroundColor: this.manageButton("B")
                            ? "rgba(106,129,158,0.5)"
                            : "rgba(106,129,158,1)",
                        }}
                ...
                <Row style={{ paddingTop: "5px", textAlign: "center" }}>
                  ...
                  <Form className="col-1" style={{ paddingTop: "0px" }}>
                    <Image
                      style={{
                        display: this.manageButton("C") ? "none" : "block",
                      }}
                      fluid={true}
                      src="Picture3.png"
                      height="100%"
                  ...
                  <Form className="col-4" style={{ alignItems: "center" }}>
                    <Button
                      disabled={this.manageButton("C")}
                      variant="secondary"
                      style={{
                        width: "80%",
                        marginBottom: "1%",
                        backgroundColor: this.manageButton("C")
                          ? "rgba(238,235,224,0.5)"
                          : "rgba(238,235,224,1)",
                        color: this.manageButton("C") ? "white" : "black",
                      }}
                ...
                <Row style={{ paddingTop: "5px", textAlign: "center" }}>
                  ...
                  <Form className="col-1" style={{ paddingTop: "0px" }}>
                    <Image
                      style={{
                        display: this.manageButton("D") ? "none" : "block",
                      }}
                      fluid={true}
                      src="Picture3.png"
                      height="100%"
                  ...
                  <Form className="col-4" style={{ alignItems: "center" }}>
                    <Button
                      disabled={this.manageButton("D")}
                      variant="secondary"
                      style={{
                        width: "80%",
                        marginBottom: "1%",
                        backgroundColor: this.manageButton("D")
                          ? "rgba(162, 72, 80, 0.5)"
                          : "rgba(162, 72, 80, 1)",
                      }}
          ...
          {this.props.playing ? (
            <Form>
              ...
              >
                <Form.Label
                  className="col-2 rounded shadow"
                  style={{
                    padding: "0.25rem",
